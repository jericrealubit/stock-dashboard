...
<template>
  <div class="flex flex-row md:flex-col text-xs md:text-base">
    <div class="mx-2">
      <h2 class="text-sm md:text-lg font-bold mb-1 md:mb-4">Selected Symbol</h2>
    ...
    <hr class="hidden md:flex border-t border-gray-300 my-4" />
    ...
    <div class="mx-2">
      <h2 class="text-sm md:text-lg font-bold mb-1 md:mb-4">Stock Symbols</h2>
      <div class="max-h-[7vh] md:max-h-[50vh] overflow-y-auto border p-1 md:p-4">
        <div>
          <ul class="divide-y divide-gray-200">
            <li
              v-for="item in sortedStockItems"
              :key="item.Symbol"
              class="py-1 md:py-2 pl-5 odd:bg-gray-300 hover:bg-gray-400 hover:text-white"
            >
              <div class="flex justify-between">
                ...
                <div :title="isSymbolFavorited(item.Symbol) ? 'unfavorite' : 'favorite'">
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="size-4 md:size-6 hover:cursor-pointer"
                  >
                    <path
